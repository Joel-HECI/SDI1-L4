...
HD_PWD='C:/Users/electronica/Downloads/SDI1-main/SDI1-main/Laboratorio 4/JOUSAMRONl4/JOUSAMRON.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log messages_storage.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source messages_storage.tcl
