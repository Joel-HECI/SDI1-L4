...
HD_PWD='C:/Users/electronica/Downloads/SDI1-main/SDI1-main/Laboratorio 4/JOUSAMRONl4/JOUSAMRON.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log messages_storage.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source messages_storage.tcl -notrace
